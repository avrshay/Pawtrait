...
// Each item: { id, orderId, productId, quantity } with orderId FK → order, productId FK → catalog.
...
// POST /orders/:id — URL has only user id. Body: { items: [{ productId, quantity }] } (quantity required per line).
